...
const RelatedDoctor = ({speciality,docId}) => {
  ...
  return (
    <div onClick={()=>scrollTo(0,0)} className='flex flex-col items-center gap-4 my-16 text-gray-900 md:max-10'>
    ...
    <button  onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='bg-Ccolor text-white px-12 py-3 rounded-full mt-10'>See More</button>
</div>
