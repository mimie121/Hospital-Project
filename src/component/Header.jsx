  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-Ccolor rounded-lg px-6 md:px-10 lg:px-20 mt-5'>
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10  md:py-[10vw] md:mb-[-30px]'>
            ...
            <a href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300 cursor-pointer'>Book appointmen <img className='w-3' src={assets.arrow_icon} alt="arrow_icon" /></a>
        </div>
